      ...
      <section id="landing" className={styles.home}>
        <div className={styles.container}>
          ...
          <div className={styles.buttonContainer}>
            ...
            <a href="https://github.com/Ozan797" target="_blank" rel="noreferrer" id={styles.link}>
              <GitHubIcon className={styles.githubIcon} />
            </a>
            <a href="https://www.linkedin.com/in/ozan-gokberk-bb6939240/" target="_blank" rel="noreferrer">
